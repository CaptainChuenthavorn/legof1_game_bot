...
def ai_drive_loop(window_name: str, duration=15):
    ...
    with mss.mss() as sct:
        ...
        while time.time() - start_time < duration:
            ...
            # === ROI near the car ===
            roi = mask_white[height - 150 : height - 50, :]
            ...
            if valid_centers:
                ...
                for cx in valid_centers:
                    cv2.circle(debug_view, (cx, 50), 5, (0, 255, 0), -1)
                cv2.line(debug_view, (center_x, 0), (center_x, 100), (255, 0, 0), 1)
                cv2.imshow("AI ROI", debug_view)
            else:
                keyboard.release('left')
                keyboard.release('right')
